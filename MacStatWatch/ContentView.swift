...
struct ContentView: View {
    ...
    /// (`MacStatWatch/Intents/MacStatWatchIntents.swift`) already use for
...
///
/// **Why not `MetricFormatting` (`MacStatKit/Models/MetricFormatter.swift`),
/// which already does all of this.** `MacStatKit_watchOS` (`project.yml`)
/// deliberately compiles a hand-picked handful of files rather than the whole
/// framework, because most of `MacStatKit` is macOS-only IOKit/XPC code or
