...
// same pattern as `FanControlBackend.swift`'s write seam and
// `StatsTransport.swift`'s original CloudKit seam: the protocol is real
// and every caller is written against it, but no conformer performs
