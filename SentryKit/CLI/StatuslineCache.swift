...
/// The last snapshot `sentryctl statusline` successfully read, kept on disk so
...
public struct StatuslineCache: Sendable {
    ...
    ///   `~/Library/Caches/dev.malekswilam.sentry/statusline.json`, using
    ...
    public static func defaultFileURL() -> URL {
        ...
        return caches
            .appendingPathComponent("dev.malekswilam.sentry", isDirectory: true)
