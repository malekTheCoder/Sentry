...
/// picker (`SentryMobile/History/PerMetricHistoryBrowser.swift`).
///
/// **Why this lives in `SentryKit` rather than next to the view.** The unit
/// test bundle (`SentryTests`) is macOS-hosted and links the *Mac* app plus
/// `SentryKit`; it cannot see any type declared inside the `SentryMobile`
...
/// `SentryTests/MetricModulePickerTests.swift`; only the chip geometry —
