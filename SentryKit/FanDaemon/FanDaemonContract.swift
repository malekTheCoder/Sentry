...
//
// **Read this before anything else in `SentryKit/FanDaemon/`.**
//
...
/// it" — the same hoisting `SentryXPCServiceName` does for the MCP
/// listener.
public enum FanDaemonNaming {
    ...
    /// hour.
    public static let label = "dev.malekswilam.sentry.fandaemon"
