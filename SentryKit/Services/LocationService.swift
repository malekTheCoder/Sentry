...
/// something much smaller and entirely honest about it: while Sentry is
...
public final class LocationService: NSObject, ObservableObject {
    ...
    private static let logger = Logger(subsystem: "dev.malekswilam.sentry.kit", category: "LocationService")
