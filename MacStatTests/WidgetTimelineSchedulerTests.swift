...
/// Coverage for `WidgetTimelineScheduler` (`MacStatKit/Sync/WidgetTimelineScheduler.swift`)
/// — the pure "when should the widget's timeline reload next" cadence logic
/// behind `MacStatWidget`'s `Provider`. Uses a fixed UTC calendar throughout
