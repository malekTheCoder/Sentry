...
/// Covers `MCPPayloads.MetricSample` — one line of `macstat watch`'s
...
final class MetricSampleTests: XCTestCase {
    ...
    func testAvailabilityAgreesWithWhatTheSnapshotCanActuallyAnswer() {
        // This mirrors the exact expression `macstat watch` builds each line
    ...
    func testEveryStreamableMetricCanNameItsUnit() {
        // `macstat watch --list-metrics` prints `id<TAB>unit` for every case,
