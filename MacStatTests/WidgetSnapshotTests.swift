...
/// Coverage for `WidgetSnapshot`/`WidgetBatteryHistory` (`MacStatKit/Sync/WidgetSnapshot.swift`)
/// — the App-Group-shared cache `MacStatWidget` reads. `WidgetSnapshotStore`
