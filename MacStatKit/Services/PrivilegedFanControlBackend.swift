...
/// `MacStatKit/FanDaemon/FanDaemonContract.swift` for why (zero signing
...
public final class PrivilegedFanControlBackend: FanControlBackend {
    ...
    private static let logger = Logger(
        subsystem: "dev.malekswilam.macstat.kit",
    ...
    private let queue = DispatchQueue(label: "dev.malekswilam.macstat.fanhelper")
