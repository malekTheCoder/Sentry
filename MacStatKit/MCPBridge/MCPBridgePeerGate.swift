...
public enum MCPBridgePeerFailure: Equatable, Sendable {
    ...
    /// Written for a person reading `macstat`'s stderr or Settings, not for a
...
///     prevents).
///
///   * The **consumers** are `macstat` and `MacStatMCP`, which are bare
...
///     `macstat-55554944088f6f87…` and `MacStatMCP-55554944c6320317…` — the
...
///     settings — exactly as `MacStatXPCServiceProtocol`'s doc comment has
