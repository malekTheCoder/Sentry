...
// compiled into MacStatKit_iOS too (that target compiles the same source
...
///
/// **Unlike the daemon's copy, this one lives in `MacStatKit`** and is
...
/// framework of ours and compiles `MacStatKit/MCPBridge/` directly). See
