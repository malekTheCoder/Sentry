...
/// Unit tests for `LocalCommandExecutor` (`SentryKit/Services/LocalCommandExecutor.swift`)
...
final class LocalCommandExecutorTests: XCTestCase {
    ...
    private func makeTestDefaults(_ name: String) -> UserDefaults {
        let suiteName = "dev.malekswilam.sentry.tests.LocalCommandExecutorTests.\(name).\(UUID().uuidString)"
