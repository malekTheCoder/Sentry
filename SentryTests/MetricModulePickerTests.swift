...
/// tab's per-metric picker (`SentryMobile/History/PerMetricHistoryBrowser.swift`),
/// and it exists in `SentryKit` precisely so this macOS-hosted bundle can
/// reach it — the view itself lives in the `SentryMobile` app target, which
