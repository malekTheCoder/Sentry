...
- **Which part of the app** — the menu bar, the Dashboard window, a widget, the iPhone or Watch app, alerts, remote sync, or the AI/MCP interface.
...
2. Look for `.ips` files whose names start with the process that crashed, plus a date — Sentry has two:
